...
Она проверена на MSSQL и PostgreSQL сборок 434, 906, 1132, 1333 и 1525;
для обоих провайдеров всех этих сборок подтверждён полный протокол.
На стенде 434 визуально подтверждено отображение
...
протокола. 14.09.2026 автоматизированный набор и ручные пункты полного
протокола успешно прошли на MSSQL и PostgreSQL сборки 1525 с UniBridge
...
Он проверяет успешную границу 200000 кодов и ошибку парсера на этапе
