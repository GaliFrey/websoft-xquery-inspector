function RunXQueryInspectorCompatibilityAgent()
{
    ...
    var supportedContractVersion = __XQI_CONTRACT_VERSION__;
    var expectedInspectorVersion = __XQI_INSPECTOR_VERSION__;
    var knownReflectionPaths = __XQI_REFLECTION_PATHS__;
    var maxXQueryLength = __XQI_MAX_XQUERY_LENGTH__;
    var scenarios = __XQI_SCENARIOS__;
    var passed = 0;
    var failed = 0;
    var skipped = 0;
